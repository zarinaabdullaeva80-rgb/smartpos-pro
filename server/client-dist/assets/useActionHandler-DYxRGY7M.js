import{u as s}from"./index-CQ9V2cdj.js";const f=()=>{const e=s();return{handleNotImplemented:n=>{e.info(`${n||"Функция"} в разработке`)},handleSuccess:n=>{e.success(n||"Операция выполнена успешно")},handleError:n=>{e.error(n||"Произошла ошибка")},handleWarning:n=>{e.warning(n||"Внимание")},handlePrint:(n,o={})=>{const t=window.open("","_blank");t?(t.document.write(`
                <!DOCTYPE html>
                <html>
                <head>
